...
import { Semaphore as h, joinPaths as u, basename as y } from "@php-wasm/util";
  ...
  for (let e = t.length - 1; e >= 0; e--) {
    for (let o = e - 1; o >= 0; o--) {
      ...
      (s.operation === "CREATE" || s.operation === "WRITE") && (i.operation === "RENAME" ? r === "same_node" ? (n[o] = [], n[e] = [
        ...
        ...n[e] || []
      ]) : i.operation === "WRITE" && r === "same_node" ? n[o] = [] : i.operation === "DELETE" && r === "same_node" && (n[o] = [], s.operation === "CREATE" && (n[e] = [])));
    }
